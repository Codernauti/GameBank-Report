...
As already said, images too large cause long time transmission with Bluetooth, 
resulting in the application hanging while transferring data, providing bad 
usability. In order to solve this problem, we have reduced image dimension, 
scaling it, converting to the JPEG format and reducing its overall quality.
